<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistoUtilizador.aspx.cs" Inherits="RegistoUtilizador" %>
...
<body>
    ...
    <div>
        ...
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BackColor="#FFFBD6" BorderColor="#FFDFAD" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" Height="435px" Width="570px">
