/*******************************
Jogo do Galo v1.1- TheLegend
José Vilela
10-01-2014

Implementaçao do Jogo do Galo
usando método minimax
**********************************/
...
iniciar:-
	...
	write('Jogador joga X ou O (X joga primeiro)? '),
	read(M),
	humano_joga(M),!,
	mostra_jogadores.
...
jogada2(humano,J,T,T2):-
	nl,nl,
	write('Jogador '),
	write(J),nl,
	write('Qual a sua jogada? '),
	read(Q),
	marcador_vazio(V),
	quadrado(T,Q,V),
...
jogada2(humano,J,T,T2):-
	nl,nl,
	write('Por favor insira uma jogada válida'),
	jogada2(humano,J,T,T2).
